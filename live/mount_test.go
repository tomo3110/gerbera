...
func TestLiveMount_UniqueIDs(t *testing.T) {
	...
	id1 := parent.Children[0].Attr["gerbera-live-id"]
	id2 := parent.Children[1].Attr["gerbera-live-id"]
	if id1 == id2 {
